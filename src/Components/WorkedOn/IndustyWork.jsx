...
const IndustyWork = () => {
    return (
        <div className='container mt-5'>
            ...
            <DiagonalCard cards={IndustyWorkIMG} d_cardTop='230px' separatorTop1='190px' separatorTop2='200px' smallSeparatorTop1='90px' smallSeparatorTop2='100px' smallCardTop='110px'/>
        </div>
    );
}
