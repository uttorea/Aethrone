                        ...
                        <div class="col product_card1">
                            <div class="card border-2 border-primary overflow-hidden">
                                ...
                                <div className="intro border-top border-5 border-primary">
                                    ...
                                    <p className='border-top text-center p-3 border-primary border-2 py-2'>Discover<i class="bi bi-arrow-right-short"></i></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col product_card2">
                            <div class="card border-2 border-primary overflow-hidden">
                                ...
                                <div className="intro border-top border-5 border-primary">
                                    ...
                                    <p className='border-top text-center border-primary border-2 py-2' >Discover<i class="bi bi-arrow-right-short"></i></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col product_card3">
                            <div class="card border-2 border-primary overflow-hidden">
                                ...
                                <div className="intro border-top border-5 border-primary">
                                    ...
                                    <p className='border-top text-center p-4 border-primary border-2 py-2'>Discover<i class="bi bi-arrow-right-short"></i></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col product_card4">
                            <div class="card border-2 border-primary overflow-hidden">
                                <img src={productimg1} alt="" className='product_img' />
                                <div className="intro border-top border-5 border-primary">
                                    ...
                                    <p className='border-top text-center p-1 border-primary border-2 py-2'>Discover<i class="bi bi-arrow-right-short"></i></p>
                                    </div>
                                </div>
                            </div>
                        </div>
