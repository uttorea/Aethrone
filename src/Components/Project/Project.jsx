            ...
            <div className="col-lg-4 col-12 text-lg-start mt-lg-5 mt-3">
              <div className="card-body1 ">
                <div className="d-flex d-md-block">
                  <h3 className="maincolor fontfamilySecondary A-project">Have</h3>
                  <h3 className="maincolor fontfamilySecondary ms-1 ms-md-0 A-project">A Project!</h3>
                </div>
                <div className="">
                  <div className="d-flex d-md-block">
                    <h3 className="card-title text-white fontfamilySecondary mt-lg-5 mt-1 fw-bold">Let's</h3>
                ...
                <p className="fontfamilySecondary mt-lg-5 mt-2 projecttext">
                  Whether you're seeking innovative solutions, collaboration opportunities, or simply have a query, our team is here to assist you every step of the way.
                </p>
              </div>
            </div>
            <div className="col-md-8 col-12 mt-5">
              <form onSubmit={handleSubmit}>
                ...
                <div className="d-flex justify-content-end mt-4">
                  <button type="submit" className="mb-5 backgroundcolormain px-5 py-2 project_btn text-white text-decoration-none rounded fontfamilySecondary">
                    Send Message
                  </button>
                </div>
              </form>
