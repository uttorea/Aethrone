...
const accordionItems = [
    {
        ...
        content: "Our rigorous Quality Control process, including First Article Inspection, guarantees every machine part meets your exact specifications before delivery, ensuring zero defects."
    },
    {
        title: "Transparency & Accountability",
        content: "Dedicated project managers provide you with weekly updates, keeping you informed on project progress and timelines."
    },
    {
        title: "Reduce Cost & Risks",
        content: "We offer Indigenization and Obsolescence Management services, helping you optimize costs and mitigate supply chain disruptions."
    },
    {
        title: "Comprehensive Quality Management",
        content: "Management System (QMS) ensures consistent quality throughout your project lifecycle."
    }
];
        ...
        <>
            ...
            <div className="mt-5 whyfocusmain" >
                ...
                <div className="accordion_card" >
                    <div className="card border px-md-4 py-md-5 px-1 py-2" style={{ backgroundColor: 'rgba(0,0,0,0.85)'}}>
                        <div className="accordion accordion-flush  w-100" id="accordionFlushExample">
                            {accordionItems.map((item, index) => (
                                <div className="accordion-item " style={{ backgroundColor: 'transparent' }} key={index}>
                                    <h2 className="accordion-header " id={`flush-heading${index}`}>
                                        <button className="accordion-button collapsed  p-md-3 p-1" type="button" data-bs-toggle="collapse" data-bs-target={`#flush-collapse${index}`} aria-expanded="false" aria-controls={`flush-collapse${index}`} style={{ backgroundColor: 'transparent', color: 'white' }}>
                                            <h5 className='px-3 focustcardtitle'>{item.title}</h5>
                                    ...
                                    {/* <div id={`flush-collapse${index}`} className="accordion-collapse collapse" aria-labelledby={`flush-heading${index}`} data-bs-parent="#accordionFlushExample">
                                        <div className="accordion-body text-light" style={{ backgroundColor: 'transparent' }}>{item.content}</div>
                                    </div> */}
                                </div>
                            ))}
                        </div>
