        ...
        <>
            <div className='advanceManu_page'>
                ...
                <div className="container">
                    <div className='advanceManu_content  col-11 col-md-10'>
                        ...
                        <div className='advanceManu_para2 fontsecondry fontfamilySecondary fontweight p-md-5 p-2 bg-black opacity-75 rounded mt-md-3 mt-1 me-md-0 me-3 col-11'>
