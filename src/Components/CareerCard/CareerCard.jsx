            ...
            <div className="container">
                ...
                <div className="row row-cols-3 g-md-4 g-2">
                    <div className="col mb-5">
                        <div className="card py-0 py-md-4 d-flex justify-content-center align-items-center border-primary border-1">
                            <img src={careerCardimg1} className="careerCardimg" alt="..." />
                        </div>
                        <div className="card-body1 mt-2">
                            <h5 className="card-title fw-bold text-primary">Our Legacy Of Innovation</h5>
                    ...
                    <div className="col mb-5">
                        <div className="card py-0 py-md-4 d-flex justify-content-center align-items-center border-primary">
                            <img src={careerCardimg2} className="careerCardimg" alt="..." />
                        </div>
                        <div className="card-body1 mt-2">
                            <h5 className="card-title fw-bold text-primary">Endless Opportunities For Growth</h5>
                    ...
                    <div className="col mb-5">
                        ...
                        <div className="card-body1 mt-2">
                            <h5 className="card-title fw-bold text-primary">Our Commitment TO Equality</h5>
