        ...
        <>
            <div className="carrerCard_page ">
                <div className="container">
                    ...
                    <p className='fontsecondary'>At Aethrone Aerospace, we are at the forefront of designing, analyzing, testing, manufacturing, and certifying aerospace platforms and systems across various domains including Aerial Robotics, Defence, Space, Aeronautical, and Clean Energy.</p>
                        ...
                        {careerCardsData.map((card, index) => (
                            <div className="col mb-5" key={index}>
                                ...
                                <div className="card-body1 mt-2">
                                    <h5 className="careertitle fw-bold maincolor">{card.title}</h5>
