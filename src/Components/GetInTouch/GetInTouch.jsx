                ...
                <div class="row mt-5 mx-5">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <a className='mb-5 bg-primary px-5 py-2 project_btn text-white text-decoration-none rounded'>Send Message</a>
                        </div>
                        </div>
                   </div>
                        </div>
