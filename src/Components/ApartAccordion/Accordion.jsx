...
const accordionItems = [
  {
    img: acordionimg1,
    heading:
      "A credible record of actualizing technically challenging projects",
    body: "Our comprehensive services streamline the development process, getting your product to market faster",
  },
  {
    img: acordionimg2,
    heading:
      "A deep understanding of manned-Unmanned systems in key aerospace and defence segment",
        ...
        <div className="row">
          <div className="col-4">
            <div className="border-0">
              <div className="">
                <h2 className="maincolor mt-5 whyAccordion ms-1 ms-md-0">
                  Why <br />
                  Aethorne Aerospace
                </h2>
                <h3 className="mt-5 foryouraccordion ms-0 ms-md-0">
                  for your
                  <br /> Model Based <br />
                  System Engineering?
                </h3>
                  ...
                  >
                    <h2 className="accordion-header" id={`heading${index}`}>
                      ...
                      >
                        ...
                        <h5 className="px-1 px-md-3 accordion-heading">
                          {item.heading}
                        </h5>
                        <span className="expand-text accordion-heading">
