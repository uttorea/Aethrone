  ...
  return (
    <div className="Engineering-Service mt-5">
      ...
      <p className=" ms-2 ms-md-0 fontsecondry">
        ...
        ability to work with a wide range of materials including metals,
        composites, elastomers, technical textiles and plastics.
      </p>
      <SimpleCard
        images={EngineerServiceIMG}
        cardHeight="248.25px"
        cardWidth="191.25px"
       
       
      />
      <p className="mt-3  ms-2 ms-md-0 fontsecondry">
        ...
        technologies, we guarantee coherence throughout our portfolio and offer
        the versatility needed to address varied business hurdles across
        industry sectors.
      </p>
    </div>
  );
