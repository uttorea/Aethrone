        ...
        <div className="container">
          <div className="launch_content text-light">
            ...
            <div className="mt-5">
              ...
              <div className="lrdimg_para2 p-5 bg-black opacity-75 rounded mt-3">
                <p className="lrdimg_para2 px-4">
            ...
            <div className="launch_btn mt-5">
              <Link
                className="btn btn-light border-2 border-primary px-5"
              ...
              <Link
                className="btn btn-light border-2 border-primary px-5 mx-5"
