                ...
                <div className="row mt-5">
                    <div className="col-sm-8">
                        <div className=" border-0">
                            ...
                            <p className="mt-4 fontsecondry fontfamilySecondary fontweight mt-5">The systems are:</p>
                            <ul className='fontsecondry fontfamilySecondary fontweight text-start '>
                                <li className='mt-3'>Land Based Inflatable Airbag</li>
                                <li className='mt-3'>Sea Based Flotation Airbag</li>
                            </ul>
                            <p className="mt-5 fontsecondry fontfamilySecondary fontweight">Furthermore, we integrate robust inflation and deflation mechanisms, ensuring swift deployment and a secure landing. By focusing on material science, precision engineering, and reliable inflation systems, we're building the future of adaptable and resilient drones.</p>
                        </div>
                    </div>
                    <div className="col-sm-4 mt-4">
                        <div className=" p-5 border-0 shadow-lg">
                            <img src={airbagSystemImg} alt="Airbag System" />
                        </div>
                    </div>
                </div>
            </div>
